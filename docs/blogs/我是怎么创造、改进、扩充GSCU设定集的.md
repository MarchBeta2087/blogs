# 我是怎么创造、改进、扩充 GSCU 设定集的

那是 2025 年 11 月 1 日，一个普通的星期六，我突发奇想：如果亚文化爱好者们组成一个全球性组织，会怎样？

抱着这个想法，我在 QQ 上写下了这么一段文字：
...
之后，我把这段文字拿去问了好几个 AI（Gemini、Kimi、DeepSeek 等等），虽然我已经不记得它们到底说了什么。
...
后来，我打算写 LFN（莱芙宁骑士团，队层次）和 LFN2018（冰火剑骑士团）的详细介绍，写了许多，在 11 月 15 日，我写出了第一套正式的设定集。

![GSCU第一套正式的设定集](../images/GSCU第一套正式的设定集.jpg)

![GSCUv1的内容，当时整套设定集的结构非常简单，也就一些docx/xslx/pdf，没有Markdown格式](../images/GSCUv1的内容.jpg)

再后来，我不断改进，扩充那几份文档的内容。

有一天，我发现，整套设定集还没有《GSCU 宪章》、《GSCU 联盟契约》、《GSCU 亚文化指导方针》的身影，只是一笔带过，于是，我在 v5.1 版本添加了这三份文档，然后用 Pandoc 把 pdf 文档转成 Markdown。

![GSCUv5.1一览](../images/GSCUv5.1一览.png)

到了 v6 版本，我将《全球亚文化俱乐部联盟》、《莱芙宁骑士团》、《冰火剑骑士团》进行了拆分。

![GSCUv6一览](../images/GSCUv6一览.png)

![GSCUv6.1的小惊喜](../images/GSCUv6.1的小惊喜.png)

接下来的几天，我继续改进、扩充（哦对了，我还在 v6.1 加了一个小故事，之后每个版本都有这个小故事），直到 v7.0.1 版本。看样子已经很成熟了，接下来，我休息了一个多月，将精力放在其他事情上。也是在这期间，我想到了一些可以补充的内容，我决定将它们全部放到期末考试结束后再来处理。

![GSCUv7.0.1一览](../images/GSCUv7.0.1一览.png)

2026 年 1 月 26 日，我突然想起了那套搁置已久的设定集，我打开 VS Code，将所有 Markdown 和图片都提取（图片是从 docx 提取的）出来做进一个新的文件夹，在这个文件夹，按照类别分到几个文件夹里，再次改进，做成了 v8 Beta 1 版本（自此不再有 docx、xlsx 和 pdf，只有 md 和 png），并发布到[GitHub](https://github.com/MarchBeta2087/GSCU/tree/v8-beta.1)上。

之后，为了让自己记住修改、添加了什么，我又加了`ChangeLog.md`，最终，`ChangeLog.md`随 v8 版本出现在了 GitHub 上。

此后，我又继续改进、扩充，从 v8 做到了 v8.1.2，此时我有一个想法，那就是把它们直接放到[GitHub Pages](https://marchbeta2087.github.io/GSCU/)上。

就在这时，Kimi 给了我一个答案，有一种名为 MkDocs 的工具，可以将 Markdown 转为 HTML 页面，经过几个小时的尝试，我终于将文档做进了 GitHub Pages 里面（结合 GitHub Actions 脚本），并且在这之后，我还发布了 v8.2 版本（这个版本将所有文档做进了一个名为`docs`的文件夹下面）

![GitHub Pages上的GSCU设定集文档](../images/GP上的GSCU设定集文档.png)

![电脑上GSCU各版本时间戳1](../images/电脑上GSCU各版本时间戳1.png)

![电脑上GSCU各版本时间戳2](../images/电脑上GSCU各版本时间戳2.png)

![手机上GSCU各版本时间戳1](../images/手机上GSCU各版本时间戳1.jpg)

![手机上GSCU各版本时间戳2](../images/手机上GSCU各版本时间戳2.jpg)

![手机上GSCU各版本时间戳3](../images/手机上GSCU各版本时间戳3.jpg)

![手机上GSCU各版本时间戳4](../images/手机上GSCU各版本时间戳4.jpg)

![手机上GSCU各版本时间戳5](../images/手机上GSCU各版本时间戳5.jpg)

如今的 v8.2.1 版本，`docs`文件夹里面是这样的：
...
这不是用几天时间就能搞定的，而是经过几十天的改进与扩充铸就的。

从 2025 年 11 月 1 日到 2026 年 1 月 31 日，我将一段草稿上的文字，变成了一个丰富多彩的世界。

这套设定并不会就此终结，而是会继续扩充下去，让这个世界更有活力。

```plaintext
从v0.0到v8.2.1的更新记录，以下时间均为北京时间：

2025年11月1日 22:30 GSCU_v0.0
2025年11月2日 16:50 GSCU_v0.1
2025年11月15日 18:56 GSCU_v1_1115
2025年11月17日 13:36 GSCU_v2_1117
2025年11月17日 14:09 GSCU_v2.1_1117_1402
2025年11月20日 01:17 GSCU_v3_1119
2025年11月20日 03:12 GSCU_v3.01_1120_0312
2025年11月20日 08:10 GSCU_v3.02_1120_0810
2025年11月22日 00:56 GSCU_v3.03_1121_2250
2025年11月25日 01:50 GSCU_v4.00
2025年11月25日 03:58 GSCU_v4.01
2025年11月25日 04:06 GSCU_v4.01_1125
2025年11月25日 07:56 GSCU_v4.02_1125_0737
2025年11月25日 10:26 GSCU_4.03
2025年11月25日 10:59 GSCU_4.10
2025年11月26日 00:29 GSCU_4.11
2025年11月26日 07:37 GSCU_4.20
2025年11月27日 11:03 GSCU_v5_alpha
2025年11月28日 00:53 GSCU_v5_beta
2025年11月28日 17:40 GSCU_v5_beta_02_20251128
2025年11月28日 19:52 GSCU_v5_beta_03_20251128
2025年11月30日 11:38 GSCU_v5
2025年11月30日 18:38 GSCU_v5_1130
2025年12月2日 00:54 GSCU_v5.1_1201
2025年12月4日 02:49 GSCU_v6
2025年12月4日 14:58 GSCU_v6.0.1
2025年12月8日 13:56 GSCU_v6.1
2025年12月11日 22:11 GSCU_v7
2025年12月12日 12:59 GSCU_v7.0.1
2026年1月26日 13:12 v8 Beta 1
2026年1月26日 19:33 v8 Beta 2
2026年1月28日 09:05 v8
2026年1月30日 11:22 v8.1
2026年1月30日 11:57 v8.1.1
2026年1月30日 17:21 v8.1.2
2026年1月30日 21:49 v8.2
2026年1月31日 22:42 v8.2.1
```

---

初版：2026-01-31 22:57 CST

再版：2026-02-01 05:26 CST

当我写下这句话的时候，已经是 2026 年 2 月 1 日凌晨五点多了，此时我刚刚上传了 v8.3 版本。
